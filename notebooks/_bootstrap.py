...
REPO_NAME = "abstractgraph-graphicalizer"
SIBLING_REPOS = (
    "abstractgraph",
    "abstractgraph-ml",
...
def bootstrap(start: Path | None = None) -> dict[str, Path]:
    ...
    candidate_src_dirs = [repo_root / "src", *(workspace_root / sibling / "src" for sibling in SIBLING_REPOS)]
    ...
    os.chdir(repo_root)
    return {"repo_root": repo_root, "workspace_root": workspace_root}
